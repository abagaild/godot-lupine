...
func show_portrait(position: String):
	var portrait_node = get_portrait_node(position)
	if portrait_node:
...
func hide_portrait(position: String):
	var portrait_node = get_portrait_node(position)
	if portrait_node:
...
func get_portrait_node(position: String) -> Control:
	match position:
		"left":
